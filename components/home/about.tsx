...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a passionate <span className='text-[#E43D12]'>Full Stack Developer</span> who bridges the gap between frontend,
        backend, and design.{" "}
      </span>
      <span
      ...
      >
        I take responsibility for building scalable systems and crafting excellent
        user experiences using modern web architecture.
      </span>
    </h1>
